...
\begin{enumerate}
    ...
    \item \textbf{Fine tuning reduces performance.} As per the IL-TUR leaderboard, we see that BERT performs \emph(better) than LegalBERT which in turn performs better than InLegalBERT. 
