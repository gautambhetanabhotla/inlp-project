...
# For each n-gram (3 to 8), we apply 4 weighting schemes.
# For each weighting scheme, we test 3 (min_df, max_df_frac) configurations:
#   1. (1, 1.00) - keep everything
#   2. (2, 1.00) - drop singletons
#   3. (2, 0.95) - drop singletons and top 5% most frequent items
